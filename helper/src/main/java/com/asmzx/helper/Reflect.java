...
public class Reflect {
    ...
    private Reflect(Class<?> type) {
        this.object = type;
        this.isClass = true;
//        if (DEBUG) L.d("type: " + type);
    }

    private Reflect(Object object) {
        this.object = object;
        this.isClass = false;
//        if (DEBUG) L.d("object: " + object);
    }
    ...
    private static Reflect on(Method method, Object object, Object... args) throws ReflectException {
        if (DEBUG)
//            L.d("method: " + method + ", object: " + object + ", args: " + Arrays.toString(args));
        accessible(method);
...
//        if (DEBUG) L.d("name: " + name + ", args: " + Arrays.toString(args));
    ...
    public Reflect callBest(String name, Object... args) throws ReflectException {
        ...
        if (bestMethod != null) {
            ...
            throw new ReflectException(new NoSuchMethodException("No best method " + name + " with params " + Arrays.toString(types) + " could be found on type " + type() + "."));
        }
    }

    private boolean matchObjectMethod(Method possiblyMatchingMethod, String desiredMethodName, Class<?>[] desiredParamTypes) {
        return possiblyMatchingMethod.getName().equals(desiredMethodName) && matchObject(possiblyMatchingMethod.getParameterTypes());
    }
